...
- (void)dataSource{
    ...
    sectionItem1.sectionHeaderHeight = 30;
    sectionItem1.sectionHeaderColor = [UIColor colorWithRed:240/255.0 green:240/255.0 blue:240/255.0 alpha:1.0];
    sectionItem1.sectionFooterHeight = 50;
    sectionItem1.sectionFooterColor = [UIColor colorWithRed:240/255.0 green:240/255.0 blue:240/255.0 alpha:1.0];
    sectionItem1.sectionFooterTitle = @"section footer";
    sectionItem1.sectionHeaderTitle = @"section header";
    
    [self.mutableArray addObject:sectionItem1];

    SelwynFormSectionItem *sectionItem2 = [[SelwynFormSectionItem alloc]init];
    sectionItem2.cellItems = datas1;
    sectionItem2.sectionHeaderHeight = 30;
    sectionItem2.sectionHeaderColor = [UIColor colorWithRed:240/255.0 green:240/255.0 blue:240/255.0 alpha:1.0];
    sectionItem2.sectionFooterHeight = 50;
    sectionItem2.sectionFooterColor = [UIColor colorWithRed:240/255.0 green:240/255.0 blue:240/255.0 alpha:1.0];
    sectionItem2.sectionFooterTitle = @"section footer";
    sectionItem2.sectionHeaderTitle = @"section header";
    
    [self.mutableArray addObject:sectionItem2];
